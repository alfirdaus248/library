...
public class MemberDataForm extends javax.swing.JFrame implements Manageable{
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MemberDataForm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new MemberDataForm().setVisible(true);
            }
        });
    }
