...
public class BorrowDataForm extends javax.swing.JFrame implements Manageable {
...
Connection connect = Connector.koneksiDb();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BorrowDataForm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new BorrowDataForm().setVisible(true);
            }
        });
    }
