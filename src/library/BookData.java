...
public class BookData extends javax.swing.JFrame implements Manageable{
...
Connection connect = Connector.koneksiDb();
    ...
    public BookData(JTable jTable1, Connection connect) {
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ...
                BookData bookData = new BookData(jTable1, connect);
                bookData.showData();
